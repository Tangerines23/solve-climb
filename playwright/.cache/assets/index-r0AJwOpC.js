const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['assets/ConfirmModal-DkbcHBm5.js', 'assets/ConfirmModal-DcCHf2iS.css'])
) => i.map((i) => d[i]);
true &&
  (function polyfill() {
...
function requireScheduler_production_min() {
  ...
  (function (exports$1) {
    ...
    var N = !1,
      ...
      Q = -1;
    function M() {
      return exports$1.unstable_now() - Q < P ? !1 : !0;
    }
    function R() {
      if (null !== O) {
    ...
    Jb(function () {
      ...
      if (0 === (b & 7)) {
        a: {
          ...
          if (k || h) {
            h =
              e.window === e ? e : (h = e.ownerDocument) ? h.defaultView || h.parentWindow : window;
            if (k) {
              if (
...
const C__Users_ghkdd_gemini_projects_solve_climb_src_components_ConfirmModal_ConfirmModal = () =>
  __vitePreload(
    () => import('./ConfirmModal-DkbcHBm5.js'),
    true ? __vite__mapDeps([0, 1]) : void 0
  ).then((mod) => mod.ConfirmModal);
__pwRegistry.initialize({
  C__Users_ghkdd_gemini_projects_solve_climb_src_components_ConfirmModal_ConfirmModal,
});

export { getDefaultExportFromCjs as g, requireReact as r };
//# sourceMappingURL=index-r0AJwOpC.js.map
