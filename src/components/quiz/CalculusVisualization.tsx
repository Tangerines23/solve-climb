...
export const CalculusVisualization: React.FC<CalculusVisualizationProps> = ({
    type,
}) => {
    ...
    const renderLimit = () => {
        ...
        return (
            <svg width="200" height="120" viewBox="0 0 200 120">
                ...
                {/* Asymptote */}
                <line x1="0" y1="100" x2="200" y2="100" stroke="var(--color-gray-700)" strokeDasharray="4" />
                <text x="180" y="115" fontSize="10" fill="var(--color-gray-500)">x → ∞</text>
            </svg>
        );
    };
    ...
    const renderDerivative = () => {
        ...
        return (
            <svg width="200" height="120" viewBox="0 0 200 120">
                ...
                <text x="10" y="115" fontSize="10" fill="var(--color-gray-500)">Tangent (기울기)</text>
            </svg>
        );
    };
