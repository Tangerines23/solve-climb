  ...
  LEVELS: {
    math: {
      ...
      equations: [
        ...
        { level: 2, name: '일차 방정식', description: '2x + 3 = 11' },
        { level: 3, name: '이차 방정식 기초', description: 'x² = 4' },
        { level: 4, name: '이차 방정식', description: 'x² + 5x + 6 = 0' },
        { level: 5, name: '연립 방정식', description: '두 개의 방정식' },
        { level: 6, name: '고급 일차 방정식', description: '복잡한 일차 방정식' },
        { level: 7, name: '고급 이차 방정식', description: '복잡한 이차 방정식' },
        { level: 8, name: '고급 연립 방정식', description: '세 개 이상의 방정식' },
        { level: 9, name: '부등식', description: 'x > 5' },
        { level: 10, name: '방정식 종합', description: '다양한 유형 종합' },
      ],
      sequence: [
