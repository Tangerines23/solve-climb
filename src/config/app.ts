  ...
  LEVELS: {
    ...
    World2: {
      기초: [
        ...
        { level: 2, name: '대칭축 기초', description: '정다각형의 선대칭' },
        ...
        { level: 7, name: '사다리꼴 넓이', description: '(윗변 + 아랫변) x 높이 / 2' },
        { level: 8, name: '원의 기초', description: '반지름과 지름' },
        { level: 9, name: '원의 둘레', description: '원주율 = 3.1 둘레 연산' },
        { level: 10, name: '원의 넓이', description: '원주율 = 3.1 넓이 연산' },
        { level: 11, name: '다각형 대각선', description: '대각선의 개수' },
        { level: 12, name: '입체도형 기본', description: '꼭짓점, 면, 모서리' },
        { level: 13, name: '직육면체 부피', description: '가로 x 세로 x 높이' },
        { level: 14, name: '피타고라스 맛보기', description: '기본 직각삼각형 3-4-5' },
        { level: 15, name: '삼각비 맛보기', description: '특수각 삼각비 tan 45°' },
      ],
      논리: [],
      대수: [],
      심화: [],
