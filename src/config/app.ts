  ...
  LEVELS: {
    ...
    World3: {
      기초: [
        ...
        { level: 5, name: '범위(Range)', description: '최대값 - 최소값' },
        { level: 6, name: '동전 던지기', description: '전체 경우의 수' },
        { level: 7, name: '가위바위보', description: '가위바위보 경우의 수' },
        { level: 8, name: '주사위 던지기', description: '합의 경우의 수' },
        { level: 9, name: '대표 뽑기(조합)', description: '기초 조합' },
        { level: 10, name: '순열(나열하기)', description: '기초 순열과 팩토리얼' },
        { level: 11, name: '확률의 기초', description: '백분율 확률 환산' },
        { level: 12, name: '확률의 응용', description: '여사건의 백분율 확률' },
        { level: 13, name: '확률의 연산', description: '덧셈 및 독립사건 곱셈' },
    ...
    World4: {
      기초: [
        ...
        { level: 8, name: '메모리 단위 기본', description: 'Byte와 KB 환산' },
        { level: 9, name: '메모리 단위 심화', description: 'KB와 MB 환산' },
        { level: 10, name: '자료구조 스택', description: 'Stack 구조 이해' },
        { level: 11, name: '자료구조 큐', description: 'Queue 구조 이해' },
