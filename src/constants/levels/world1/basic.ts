export const BASIC_LEVELS = [
  ...
  { level: 11, name: '두 걸음씩', description: '두 자릿수 덧셈, 올림X' },
  { level: 12, name: '무거운 배낭', description: '두 자릿수 덧셈, 올림O' },
  { level: 13, name: '세 개의 돌탑', description: '3항 연산' },
  { level: 14, name: '곱하기 우선', description: '덧셈보다 곱셈이 먼저' },
  { level: 15, name: '암산왕', description: '복합 실전 문제 (대피소)' },
  { level: 16, name: '괄호의 벽', description: '2 x (3 + 4)' },
  { level: 17, name: '큰 수의 위압감', description: '100단위 뺄셈' },
  ...
  { level: 25, name: '소수/분수 믹스', description: '정수가 아닌 수 적응 (캠프)' },
