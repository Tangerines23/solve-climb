...
export const WORLD_TIPS: Record<string, Record<number, TipItem>> = {
  World2: {
    ...
    8: {
      ...
      strategy:
        '원주율 3.1을 곱해 계산합니다. 소수 한 자리 곱셈으로 출제되며, 6.2 * 반지름 혹은 3.1 * 반지름²으로 생각하면 계산하기 쉽습니다.',
    },
    9: {
      title: '9레벨: 대칭축 기초',
      tip: '정다각형의 대칭축 개수',
    ...
    10: {
      ...
      example: '변 3, 4 -> 빗변 5',
      strategy:
        '자주 쓰이는 피타고라스 수의 비율(3:4:5, 5:12:13, 8:15:17)을 암기하면 계산이 빠릅니다.',
    },
    11: {
      title: '11레벨: 피타고라스 심화',
      tip: '더 큰 직각삼각형 변의 길이',
      ...
      strategy:
        '심화 피타고라스 수(7:24:25, 9:40:41, 11:60:61)도 눈에 익혀두면 루트 계산이 필요 없습니다.',
    },
    12: {
      title: '12레벨: 입체도형 기본',
      tip: '꼭짓점, 면, 모서리',
    ...
    13: {
      ...
      strategy:
        '원기둥 부피 계산 시 원주율 3.1을 사용합니다. 밑넓이(3.1 * r²)에 높이를 곱하며, 최종 결과는 항상 정수 또는 소수 한 자리로 정밀하게 떨어집니다.',
    },
    14: {
      title: '14레벨: 입체도형 겉넓이',
      tip: '정육면체의 겉넓이',
