...
describe('QuickActionsSection', () => {
  ...
  it('should handle stamina increment', async () => {
    ...
    if (incrementButton) {
      ...
      expect((vi.mocked(useUserStore) as any)().debugSetStamina).toHaveBeenCalled();
    }
  });
  ...
  it('should handle minerals increment', async () => {
    ...
    if (incrementButton) {
      ...
      expect((vi.mocked(useUserStore) as any)().debugSetMinerals).toHaveBeenCalled();
    }
  });
  ...
  it('should toggle infinite stamina', async () => {
    ...
    expect((vi.mocked(useDebugStore) as any)().setInfiniteStamina).toHaveBeenCalled();
  });
