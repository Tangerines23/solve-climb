            ...
            {items.map((item, idx) => (
              <div key={idx} className="effect-card">
                <div
                  ...
                  style={{ backgroundColor: `color-mix(in srgb, ${item.color}, transparent 87%)` }}
                >
            ...
            {effects.map((effect, idx) => (
              <div key={idx} className="effect-card">
                <div
                  className="effect-icon-wrapper"
                  style={{
                    backgroundColor: `color-mix(in srgb, ${effect.color}, transparent 87%)`,
                  }}
                >
