...
export function ModeSelectModal({
  ...
  return (
    ...
    >
      <div className="mode-select-modal-header-content">
      ...
      <div className="mode-select-modal-actions">
        <button className="btn-base btn-secondary mode-select-modal-close" onClick={onClose}>
          취소
        </button>
      </div>
    </BaseModal>
