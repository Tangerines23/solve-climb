...
export function DebugPage() {
    ...
    return (
        <div className="debug-page page-container">
            ...
            <main className="debug-page-content" style={{
                ...
                <section className="debug-section-group">
                    <h2 style={{ borderBottom: '1px solid var(--color-bg-tertiary)', paddingBottom: 'var(--spacing-sm)', marginBottom: 'var(--spacing-xl)' }}>
                        🗺️ 전체 지도 (Sitemap)
                    </h2>
                    <SitemapTree />
                </section>
                ...
                <section className="debug-section-group">
                    ...
                    <div style={{ backgroundColor: 'var(--color-bg-secondary)', padding: 'var(--spacing-lg)', borderRadius: 'var(--rounded-card)' }}>
