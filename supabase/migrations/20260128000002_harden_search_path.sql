-- ============================================================================
-- 보안 강화 마이그레?�션 (Server Function Hardening)
-- ?�성?? 2026.01.28
-- 목적: SECURITY DEFINER ?�수?�의 search_path�?public?�로 고정?�여 Search Path Hijacking 방�?
-- ============================================================================

-- Reference: https://supabase.com/docs/guides/database/postgres/row-level-security#security-definer-functions
-- 멱등: ?�수가 ?�으�?건너?� (EXCEPTION WHEN undefined_object)
...
SELECT 'security_hardened', JSONB_build_object('reason', 'Applied search_path=public to all SECURITY DEFINER functions')
